...
The project was updated and tested on a MacBook Air M1 / Apple Silicon using macOS, zsh, and Python 3.11.

### macOS / Linux

On macOS, XGBoost requires the OpenMP runtime. If XGBoost fails to load with a
missing `libomp.dylib` error, install the system dependency with Homebrew:
...
Do not commit local virtual environments, generated caches, private user data, purchase history, customer images, or `.env` files.
