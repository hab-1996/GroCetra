...
if __name__ == "__main__":
    ...
    Bavaria_path = DATASETS_DIR / "Raw_Data" / "Datapoints" / "Bavaria"
    Bavaria_file = DATASETS_DIR / "Raw_Data" / "grocery_items_bavaria.csv"
    process_bavaria_data(Bavaria_path, Bavaria_file)


    # Create a database for Schleswig Holstein State
    Holstein_path = DATASETS_DIR / "Raw_Data" / "Datapoints" / "Schleswig-Holstein"
    Holstein_file = DATASETS_DIR / "Raw_Data" / "grocery_items_Schleswig_Holstein.csv"
    process_schleswig_holstein_data(Holstein_path, Holstein_file)


    # Create a database for Combined State
    folders = {
        "Bavaria": DATASETS_DIR / "Raw_Data" / "Datapoints" / "Bavaria",
        "Schleswig-Holstein": DATASETS_DIR / "Raw_Data" / "Datapoints" / "Schleswig-Holstein"
    }
    combined_states_file = DATASETS_DIR / "Raw_Data" / "grocery_items_two_state.csv"
    process_combined_states_data(folders, combined_states_file)


    # Take Bavaria Database to train model
    grocery_data = pd.read_csv(DATASETS_DIR / "Raw_Data" / "grocery_items_bavaria.csv")
    grocery_data.rename(columns={'name': 'Items'}, inplace=True)

    # Delete old 'Item_lists.csv' file if exists 
    csv_file_path = DATASETS_DIR / "Model_Output" / "Price_Prediction" / "Item_lists.csv"
    ...
    models_folder = MODEL_DIR / "XGBoost"
    ...
    error_metrics_path = DATASETS_DIR / "Model_Output" / "Model_Performance" / "error_metrics_all_items_xgboost.csv"
    ...
    ITEM_DETAILS_EXCEL_FILE = DATASETS_DIR / "Raw_Data" / "Item_details.xlsx"
    ITEM_LIST_CSV_FILE = DATASETS_DIR / "Model_Output" / "Price_Prediction" / "Item_lists.csv"
